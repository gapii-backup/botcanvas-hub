...
export function DashboardSidebar({ 
  ...
  return (
    <div className="min-h-screen flex w-full bg-background">
      ...
      {/* Mobile Sidebar */}
      <div className={cn(
        "fixed top-16 left-0 bottom-0 w-64 bg-card border-r border-border z-40 transition-transform duration-300 lg:hidden flex flex-col",
        ...
        <div className="p-4 border-t border-border mt-auto">
          ...
          <Button 
            variant="ghost" 
            className="w-full justify-start gap-2 px-3 mt-2 text-destructive hover:text-destructive hover:bg-destructive/10"
